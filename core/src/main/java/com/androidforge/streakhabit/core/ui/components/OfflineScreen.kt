...
fun OfflineScreen(
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.offline_illustration_placeholder), // Placeholder drawable
            contentDescription = stringResource(R.string.cd_offline_illustration),
